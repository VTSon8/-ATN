                                                        ...
                                                        <div class="product-img " style="border: none;">
                                                            ...
                                                            <div class="button-add d-none d-md-flex">
                                                                <button type="button" class="btnQuickView quick-view"
                                                                        data-handle="/products/trong-dong"
                                                                        data-tooltip="Xem nhanh"><i
                    ...
                    <div class="row">
                        <div class="col-12 col-md-3 ">
                            <div class="item banner-effect">
                                <a href="{{route('home')}}/collections/truyen-tranh">
                                    <picture>
                        ...
                        <div class="col-12 col-md-9 ">
                            <div class="item banner-effect">
                                <a href="{{route('home')}}/products/ai-bao-romcom-khong-co-ngoai-doi-thuc-tap-4-ban-co-qua">
                                    <picture>
                                        <source media="(min-width: 768px)"
